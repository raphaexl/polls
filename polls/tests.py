...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        """
            Question with a pub_date in the future are not displayed in the index page.
        """
    ...
    def test_two_past_questions(self):
        """
            The question index Page may display multiples questions.
        """
...
class QuestionDetailViewTests(TestCase):
    ...
    def test_past_question(self):
        ...
        """
        past_question = create_question(question_text="Past quesiton.", days=-5)
